...
namespace _06_Arrays
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //DeğşkenTürü[] DiziAdı = new DeğişkenTürü[ElemanSayısı]
            //string[] colors2 = new string[] {"a","b","c","d" };
            ...
            //int[] numbers = { 45, 85, 96, 63, 74, 10, 22, 26 };
            ...
            //    sum += numbers[i];
            //}
            //Console.WriteLine($"Dizi Elemanları Toplamı: {sum}");
